...
@Controller
@RequestMapping("/abuseReport/animaniac")
public class AbuseReportAnimaniacController extends AbstractController {
	...
	public AbuseReportAnimaniacController() {
		super();
	}
	...
	public ModelAndView save(final AbuseReport abuseReport, final BindingResult binding) {
		...
		if (binding.hasErrors())
			...
			try {
				...
				result = new ModelAndView("redirect:/animaniac/view.do?animaniacId=" + abuseReport.getReported().getId());
	...
	protected ModelAndView createEditModelAndView(final AbuseReport abuseReport, final String message) {
		...
		result = new ModelAndView("abuseReport/animaniac/edit");
