...
public class ConfigurationTest extends AbstractTest {
	...
	public void editConfigurationTest1() {
		this.templateEditConfiguration("admin", 360000000, 1.0, null);
	}
	//sin loguearse
	@Test
	public void editConfigurationTest2() {
		this.templateEditConfiguration(null, 360000000, 1.0, IllegalArgumentException.class);
	}
	...
	protected void templateEditConfiguration(final String username, final long cachedTime, final double partnerFee, final Class<?> expected) {
		Class<?> caught;
		...
		try {
			...
			configuration.setCacheTime(cachedTime);
			configuration.setPartnerFee(partnerFee);
